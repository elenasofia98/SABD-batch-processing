...
public class TLCMainDetachPreprocessing {
    public static void writeTime(String path, long durationpre, long duration1, long duration2, int worker) throws IOException {
        ...
        String sep = ",";
        out.write(durationpre+sep+duration1+sep+duration2+sep+worker+"\n");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            app.preprocessing(filenames, dimensions, "dataset");
            long end_pre = System.currentTimeMillis();
            long duration_pre = end_pre - start_pre;

            JavaRDD<TaxiRoute> rdd = app.loadPreprocessed("dataset");
            rdd = rdd.cache();
